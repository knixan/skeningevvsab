...
const Hero: React.FC = () => {
  return (
    <>
      ...
      {/* Desktop */}
      <div className="hidden md:flex h-screen justify-center items-start bg-background">
        <div className="relative h-full w-full">
          ...
          {/* Text */}
          <div className="absolute inset-0 flex flex-col items-center justify-start pt-32 text-center">
            <h1 className="mb-4 text-6xl font-extrabold tracking-tight text-red-800">
              Din lokala expert på VVS!
            </h1>
            <p className="mb-6 text-4xl font-extrabold text-sky-700">
              Små i storlek – stora på service
            </p>
            <Button asChild>
              <Link
                href="#contact"
                className="inline-flex items-center bg-red-800 hover:scale-105 transition-transform duration-200"
              >
                Kontakta oss
                <ArrowRight className="ml-2 h-4 w-4" />
              </Link>
