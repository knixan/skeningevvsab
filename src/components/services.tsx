...
import { Wrench, Flame, ShowerHead, ChefHat, Hammer, Package, Leaf } from "lucide-react";
  ...
  >
    ...
    <div className="mt-16 flex flex-col md:flex-row items-center justify-center gap-12">
      ...
      <div className="w-full md:w-1/2 lg:w-3/5 text-center md:text-left">
        <h3 className="text-3xl font-bold text-sky-700 mb-6">Vi löser dina VVS-problem</h3>
        <p className="text-lg text-muted-foreground mb-8">
          Oavsett om det gäller akuta reparationer, planerade installationer eller rådgivning kring energieffektivitet, finns Skeninge VVS här för dig. Vårt erfarna team ser till att arbetet utförs professionellt och enligt högsta standard.
        </p>
